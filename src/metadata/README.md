 ...
 * [triffo.yml](triffo.yml)
     * Determines how your purl.obolibrary.org/obo/triffo/ redirects will be handled
     ...
     * Paste in the contents of [triffo.yml](triffo.yml)
 ...
 * [triffo.md](triffo.md)
     ...
     * Paste in the contents of [triffo.md](triffo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
